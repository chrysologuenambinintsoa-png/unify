...
namespace FreeTrial.Security
{
    ...
    public class MembershipBusinessRulesBase : BusinessRules
    {
        ...
        protected virtual void PrepareUserRow()
        {
            ...
            dt = ((DateTime)(SelectFieldValue("PwdAttemptWindowStart")));
            if (dt.Equals(new DateTime(1754, 1, 1)))
                UpdateFieldValue("PwdAttemptWindowStart", null);
            dt = ((DateTime)(SelectFieldValue("PwdAnsAttemptWindowStart")));
            if (dt.Equals(new DateTime(1754, 1, 1)))
                UpdateFieldValue("PwdAnsAttemptWindowStart", null);
        }

...
* Copyright 2020-2025 Code On Time LLC; Licensed MIT; http://codeontime.com/license
        ...
        $.widget("touch.pagecontainer", {
            ...
            _handleDestination: function (to) {
                ...
                if (to) {
                    ...
                    if (history.stack[history.activeIndex].pageUrl === to)
                        to = history.stack[history.activeIndex].url;
                    else
